...
namespace Manage.Controllers
{
    public class DruggistController
    {
        ...
        public void CreateDruggist()
        {
            ...
            {
                ConsoleHelper.WriteTextWithColor(ConsoleColor.Blue, "Please Enter Druggist Name:");
                string druggistName = Console.ReadLine();
                ConsoleHelper.WriteTextWithColor(ConsoleColor.Blue, "Please Enter Druggist Surname:");
                string druggistSurname = Console.ReadLine();
                ConsoleHelper.WriteTextWithColor(ConsoleColor.Blue, "Please Enter Druggist Age:");
                string druggistAge = Console.ReadLine();
                byte age;
                bool result = byte.TryParse(druggistAge, out age);
                if (result)
                {
                ConsoleHelper.WriteTextWithColor(ConsoleColor.Blue, "Please Enter Druggist Experience:");
                    ...
                    if (result)
                    {
                     ConsoleHelper.WriteTextWithColor(ConsoleColor.DarkBlue, "All DrugStores:");
                        ...
                        {
                            ConsoleHelper.WriteTextWithColor(ConsoleColor.Blue, $"Id:{drugstore.Id} Name:{drugstore.Name} Owner:{drugstore.Onwer.Name}");
                        }
                     ConsoleHelper.WriteTextWithColor(ConsoleColor.Blue, "Please Enter DrugStore Id:");
                        ...
                        if (result)
                        {
                            ...
                            {
                                ConsoleHelper.WriteTextWithColor(ConsoleColor.Red, "Drugstore id doesnt exist");
                    ...
                    {
                        ConsoleHelper.WriteTextWithColor(ConsoleColor.Red, "Please enter correct experience");
        ...
        public void UpdateDruggist()
        {
            ...
            ConsoleHelper.WriteTextWithColor(ConsoleColor.Cyan, "Please Enter Druggist Id:");
                ...
                if (result)
                {
                    ...
                    if (druggist != null)
                    {
                     ...
                     ConsoleHelper.WriteTextWithColor(ConsoleColor.Cyan, "Enter New Druggist Age:");
                        string newAge = Console.ReadLine();
                        byte age;
                        result = byte.TryParse(newAge, out age);
                        if (result)
                        {
                         ConsoleHelper.WriteTextWithColor(ConsoleColor.Cyan, "Enter New Druggist Experience:");
